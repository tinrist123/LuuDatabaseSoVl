document.addEventListener("DOMContentLoaded", function () {
    ...
    let Listproduct_image = document.getElementsByClassName('js-product_image');
    ...
    for (let index = 0; index < listBtn.length; index++) {
        listBtn[index].addEventListener('click', function (e) {
            ...
            product_image = Listproduct_image[index].value;

            let variablesPost = "product_id=" + product_id + "&product_name=" + product_name + "&product_price=" + product_price + "&product_image=" + product_image + "&dataCome=1";
